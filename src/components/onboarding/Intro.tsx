...
export const Intro: React.FC<StepProps> = ({ goToNextStep }) => {
    ...
    return (
        <>
            <div className="hidden lg:flex min-h-screen flex-col justify-between px-8 pb-20 pt-35 w-full max-w-[1000px] mx-auto">
                <main>
                    <div className="mb-8 flex flex-col gap-4">
                        <h1 className="font-kccganpan text-4xl text-primary-300 leading-relaxed">
                            우리 가족의 대화가 흐르는 곳, <br /> Everflow에 오신 걸 환영합니다!
                        </h1>
                        <p className="font-kccganpan text-[28px] text-primary-200">
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            type="checkbox"
                            className="size-9 rounded border-gray-300"
                            checked={allowed}
                            onChange={() => {
                        ...
                        />
                        <label
                            className="cursor-pointer text-xl text-dark-gray"
                            onClick={() => goToNextStep(STEP.TERMS_CONDITIONS)}
                        >
                ...
                <footer className="flex flex-wrap justify-center gap-4 self-center sm:self-end z-50">
                    <button
                        ...
                        className="h-[80px] w-[250px] shrink-0 rounded-2xl border-2 text-primary-300 border-primary-300 bg-transparent text-2xl font-semibold transition-colors hover:bg-primary-300 hover:text-white"
                    >
                        가족 생성하기
                    </button>
