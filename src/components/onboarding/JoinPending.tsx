        ...
        <div className="relative flex min-h-screen w-full flex-col items-center justify-center p-8">
            <main className="w-full max-w-3xl">
                <div className="flex flex-col gap-2 font-kccganpan">
                    <div className="font-kccganpan text-primary-300">
            ...
            {isModalOpen && (
                <div
                    className="absolute bottom-1/4 left-1/2 flex w-11/12 max-w-xl -translate-x-1/2 flex-col gap-4 rounded-2xl border-2 border-primary-200 bg-white p-6 shadow-lg"
